...
def project_management():
    ...
    if not projects_df.empty:
        ...
        display_df['leader'] = display_df['leader_id'].apply(lambda x: persons_dict.get(x, f"ID:{x}") if x else "无")
        ...
        with col_view:
            ...
            if st.button("查看详细信息"):
                ...
                # 显示负责人
                leader_name = persons_dict.get(project_data['leader_id'], f"ID:{project_data['leader_id']}")
                ...
                if project_data['members']:
                    ...
                    for member_id in member_ids:
                        member_name = persons_dict.get(member_id, f"ID:{member_id}")
